...
- $\alpha_1 = \frac{\alpha_F}{m} = \frac{0.05}{10} = 0.005$
- $df = n-k = 30 - 5 = 25$
- $t_{df,\alpha/2} = t_{25,0.0025} = 3.078$
- $ME_{ij} = t_{df,\alpha/2}\sqrt{MSE}\sqrt{\frac{2}{n_i}} = 3.078\sqrt{0.22472}\sqrt{\frac{2}{6}} = 0.8424$
...
| A   |                    |                    |                   |                   |     |
| B   | $0.1 < 0.8424$     |                    |                   |                   |     |
| C   | $0.7 < 0.8424$     | $0.6 < 0.8424$     |                   |                   |     |
| D   | $0.55 < 0.8424$    | $0.45 < 0.8424$    | $0.15 < 0.8424$   |                   |     |
| E   | $0.9833 > 0.8424$* | $0.8833 > 0.8424$* | $0.2833 < 0.8424$ | $0.4333 < 0.8424$ |     |
